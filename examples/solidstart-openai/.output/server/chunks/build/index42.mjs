...
function I() {
  ...
  } })), m() && i[0] + ssrHydrationKey() + i[1], ssrAttribute("value", escape(u(), true), false), ssrAttribute("disabled", s() !== "ready", true));
}
