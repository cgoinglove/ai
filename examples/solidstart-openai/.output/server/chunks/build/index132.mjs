...
const h = async (o) => {
  ...
  return to({ model: pt("gpt-4o"), messages: r, toolCallStreaming: true, maxSteps: 5, tools: { getWeatherInformation: { description: "show the weather in a given city to the user", parameters: z.object({ city: z.string() }), execute: async ({ city: m }) => {
