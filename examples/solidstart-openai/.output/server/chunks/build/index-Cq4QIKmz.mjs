import { A as At$1, E, d as ka$1, N as Na$1, r as ra$1, a as ae, s as sa$1, i as ia$1, U, o as oa$1, k as kr$1, u as ue, W as W$1, p as pa$1, C, f as ua$1, I as Ia$1, g as Ea$1, H as He$1, v as ve$1, Y as Y$1, h as la$1, w as wa, j as da$1, y as ya, m as ca$1, n as aa$1, q as fa, t as ma, _ as _a$1, z as na$1, B as ga, D as ba, F as ha, G as va } from './index-B97T_aK9.mjs';
import { z } from 'zod';

var Sa = typeof globalThis == "object" ? globalThis : global, ye$1 = "1.9.0", Yt = /^(\d+)\.(\d+)\.(\d+)(-(.+))?$/;
function Ta(e) {
  var t = /* @__PURE__ */ new Set([e]), r = /* @__PURE__ */ new Set(), a = e.match(Yt);
...
var _a = Ta(ye$1), Ia = ye$1.split(".")[0], ke$1 = Symbol.for("opentelemetry.js.api." + Ia), De$1 = Sa;
function Rt(e, t, r, a) {
  var s;
  a === void 0 && (a = false);
...
function qe$1(e) {
  ...
  if (!(!a || !_a(a))) return (r = De$1[ke$1]) === null || r === void 0 ? void 0 : r[e];
}
function Ct(e, t) {
...
function Ne$1(e, t, r) {
  var a = qe$1("diag");
  if (a) return r.unshift(t), a[e].apply(a, Ca([], Ra(r), false));
}
var W;
(function(e) {
...
var Aa = function(e, t) {
  ...
  if (arguments.length === 2) for (var a = 0, s = t.length, n; a < s; a++) (n || !(a in t)) && (n || (n = Array.prototype.slice.call(t, 0, a)), n[a] = t[a]);
  return e.concat(n || Array.prototype.slice.call(t));
}, Ma = "diag", Ye$1 = function() {
  function e() {
    function t(s) {
      return function() {
        for (var n = [], o = 0; o < arguments.length; o++) n[o] = arguments[o];
        var l = qe$1("diag");
        if (l) return l[s].apply(l, ja([], Aa(n), false));
      };
    }
    var r = this, a = function(s, n) {
      ...
      var d = qe$1("diag"), m = Ea((l = n.logLevel) !== null && l !== void 0 ? l : W.INFO, s);
...
var Oa = /* @__PURE__ */ function() {
  ...
  return e.prototype.active = function() {
    ...
    return r.call.apply(r, qa([a], Da(s), false));
  ...
  if (arguments.length === 2) for (var a = 0, s = t.length, n; a < s; a++) (n || !(a in t)) && (n || (n = Array.prototype.slice.call(t, 0, a)), n[a] = t[a]);
  return e.concat(n || Array.prototype.slice.call(t));
}, lt$1 = "context", Ja = new Ua(), lr = function() {
  function e() {
  }
  return e.getInstance = function() {
    ...
    return (s = this._getContextManager()).with.apply(s, Fa([t, r, a], $a(n), false));
  }, e.prototype.bind = function(t, r) {
...
var ur = "0000000000000000", cr = "00000000000000000000000000000000", Ba = { traceId: cr, spanId: ur, traceFlags: ht.NONE }, Oe$1 = function() {
  function e(t) {
    t === void 0 && (t = Ba), this._spanContext = t;
  }
...
}(), Pt = Na("OpenTelemetry Context Key SPAN");
function Et(e) {
  return e.getValue(Pt) || void 0;
}
function Ga() {
  return Et(lr.getInstance().active());
}
function At(e, t) {
...
function Wa(e, t) {
  return At(e, new Oe$1(t));
}
function pr(e) {
  var t;
  return (t = Et(e)) === null || t === void 0 ? void 0 : t.spanContext();
}
var Va = /^([0-9a-f]{32})$/i, za = /^[0-9a-f]{16}$/i;
function Xa(e) {
  return Va.test(e) && e !== cr;
}
function Ha(e) {
  return za.test(e) && e !== ur;
}
function dr(e) {
  return Xa(e.traceId) && Ha(e.spanId);
}
function Ka(e) {
  return new Oe$1(e);
}
var ut = lr.getInstance(), mr = function() {
  function e() {
  }
...
var Qa = new mr(), Za = function() {
  ...
  return e.prototype.startSpan = function(t, r, a) {
    ...
    return t ? (this._delegate = t, this._delegate) : Qa;
  }, e;
}(), en = function() {
  function e() {
  }
...
}(), tn = new en(), Qt = function() {
  function e() {
  }
  return e.prototype.getTracer = function(t, r, a) {
    var s;
    return (s = this.getDelegateTracer(t, r, a)) !== null && s !== void 0 ? s : new Za(this, t, r, a);
  }, e.prototype.getDelegate = function() {
    var t;
    return (t = this._delegate) !== null && t !== void 0 ? t : tn;
...
var ct = "trace", rn = function() {
  function e() {
    this._proxyTracerProvider = new Qt(), this.wrapSpanContext = Ka, this.isSpanContextValid = dr, this.deleteSpan = La, this.getSpan = Et, this.getActiveSpan = Ga, this.getSpanContext = pr, this.setSpan = At, this.setSpanContext = Wa;
  }
  return e.getInstance = function() {
    return this._instance || (this._instance = new e()), this._instance;
    ...
    Ct(ct, Ye$1.instance()), this._proxyTracerProvider = new Qt();
  }, e;
}(), an = rn.getInstance(), nn = Object.defineProperty, jt = (e, t) => {
  for (var r in t) nn(e, r, { get: t[r], enumerable: true });
};
function sn({ execute: e, onError: t = () => "An error occurred." }) {
  let r;
...
function Zs({ status: e, statusText: t, headers: r, execute: a, onError: s }) {
  return new Response(sn({ execute: a, onError: s }).pipeThrough(new TextEncoderStream()), { status: e, statusText: t, headers: Ce$1(r, { contentType: "text/plain; charset=utf-8", dataStreamVersion: "v1" }) });
}
...
var fr = "AI_InvalidArgumentError", hr = `vercel.ai.error.${fr}`, on = Symbol.for(hr), gr, R = class extends E {
  constructor({ parameter: e, value: t, message: r }) {
    super({ name: fr, message: `Invalid argument for parameter ${e}: ${r}` }), this[gr] = true, this.parameter = e, this.value = t;
  }
  static isInstance(e) {
    return E.hasMarker(e, hr);
  }
};
gr = on;
var vr = "AI_RetryError", yr = `vercel.ai.error.${vr}`, ln = Symbol.for(yr), wr, Zt = class extends E {
  constructor({ message: e, reason: t, errors: r }) {
    super({ name: vr, message: e }), this[wr] = true, this.reason = t, this.errors = r, this.lastError = r[r.length - 1];
  }
  static isInstance(e) {
...
wr = ln;
var un = ({ maxRetries: e = 2, initialDelayInMs: t = 2e3, backoffFactor: r = 2 } = {}) => async (a) => br(a, { maxRetries: e, delayInMs: t, backoffFactor: r });
async function br(e, { maxRetries: t, delayInMs: r, backoffFactor: a }, s = []) {
  try {
    return await e();
  } catch (n) {
    if (W$1(n) || t === 0) throw n;
    const o = pa$1(n), l = [...s, n], c = l.length;
    if (c > t) throw new Zt({ message: `Failed after ${c} attempts. Last error: ${o}`, reason: "maxRetriesExceeded", errors: l });
    if (n instanceof Error && C.isInstance(n) && n.isRetryable === true && c <= t) return await ua$1(r), br(e, { maxRetries: t, delayInMs: a * r, backoffFactor: a }, l);
    throw c === 1 ? n : new Zt({ message: `Failed after ${c} attempts with non-retryable error: '${o}'`, reason: "errorNotRetryable", errors: l });
  }
}
function xr({ maxRetries: e }) {
  if (e != null) {
  ...
  const t = e != null ? e : 2;
  return { maxRetries: t, retry: un({ maxRetries: t }) };
}
...
function Sr({ model: e, settings: t, telemetry: r, headers: a }) {
  var s;
...
function Tr({ isEnabled: e = false, tracer: t } = {}) {
  return e ? t || an.getTracer("ai") : cn;
}
...
}, fn = [{ mimeType: "image/gif", bytesPrefix: [71, 73, 70], base64Prefix: "R0lG" }, { mimeType: "image/png", bytesPrefix: [137, 80, 78, 71], base64Prefix: "iVBORw" }, { mimeType: "image/jpeg", bytesPrefix: [255, 216], base64Prefix: "/9j/" }, { mimeType: "image/webp", bytesPrefix: [82, 73, 70, 70], base64Prefix: "UklGRg" }, { mimeType: "image/bmp", bytesPrefix: [66, 77], base64Prefix: "Qk" }, { mimeType: "image/tiff", bytesPrefix: [73, 73, 42, 0], base64Prefix: "SUkqAA" }, { mimeType: "image/tiff", bytesPrefix: [77, 77, 0, 42], base64Prefix: "TU0AKg" }, { mimeType: "image/avif", bytesPrefix: [0, 0, 0, 32, 102, 116, 121, 112, 97, 118, 105, 102], base64Prefix: "AAAAIGZ0eXBhdmlm" }, { mimeType: "image/heic", bytesPrefix: [0, 0, 0, 32, 102, 116, 121, 112, 104, 101, 105, 99], base64Prefix: "AAAAIGZ0eXBoZWlj" }], hn = (e) => {
  const t = typeof e == "string" ? Ia$1(e) : e, r = (t[6] & 127) << 21 | (t[7] & 127) << 14 | (t[8] & 127) << 7 | t[9] & 127;
  return t.slice(r + 10);
};
function gn(e) {
  return typeof e == "string" && e.startsWith("SUQz") || typeof e != "string" && e.length > 10 && e[0] === 73 && e[1] === 68 && e[2] === 51 ? hn(e) : e;
}
function vn({ data: e, signatures: t }) {
  const r = gn(e);
...
var _r = "AI_NoObjectGeneratedError", Ir = `vercel.ai.error.${_r}`, yn = Symbol.for(Ir), Rr, Ze$1 = class Ze extends E {
  constructor({ message: e = "No object generated.", cause: t, text: r, response: a, usage: s, finishReason: n }) {
    super({ name: _r, message: e, cause: t }), this[Rr] = true, this.text = r, this.response = a, this.usage = s, this.finishReason = n;
  }
  static isInstance(e) {
    return E.hasMarker(e, Ir);
  }
};
Rr = yn;
var Cr = "AI_DownloadError", Pr = `vercel.ai.error.${Cr}`, wn = Symbol.for(Pr), Er, pt$1 = class pt extends E {
  constructor({ url: e, statusCode: t, statusText: r, cause: a, message: s = a == null ? `Failed to download ${e}: ${t} ${r}` : `Failed to download ${e}: ${a}` }) {
    super({ name: Cr, message: s, cause: a }), this[Er] = true, this.url = e, this.statusCode = t, this.statusText = r;
  }
  static isInstance(e) {
    return E.hasMarker(e, Pr);
  }
};
Er = wn;
async function bn({ url: e }) {
  var t;
  const r = e.toString();
  try {
...
var Ar = "AI_InvalidDataContentError", jr = `vercel.ai.error.${Ar}`, xn = Symbol.for(jr), Mr, er = class extends E {
  constructor({ content: e, cause: t, message: r = `Invalid data content. Expected a base64 string, Uint8Array, ArrayBuffer, or Buffer, but got ${typeof e}.` }) {
    super({ name: Ar, message: r, cause: t }), this[Mr] = true, this.content = e;
  }
  static isInstance(e) {
    return E.hasMarker(e, jr);
  }
};
Mr = xn;
var Nr = z.union([z.string(), z.instanceof(Uint8Array), z.instanceof(ArrayBuffer), z.custom((e) => {
  var t, r;
...
function et$1(e) {
  ...
  if (typeof e == "string") try {
    ...
    throw new er({ message: "Invalid data content. Content string is not a base64-encoded media.", content: e, cause: t });
  }
  if (e instanceof ArrayBuffer) return new Uint8Array(e);
  throw new er({ content: e });
}
function Sn(e) {
  try {
...
var kr = "AI_InvalidMessageRoleError", Dr = `vercel.ai.error.${kr}`, Tn = Symbol.for(Dr), qr, _n = class extends E {
...
async function yt({ prompt: e, modelSupportsImageUrls: t = true, modelSupportsUrl: r = () => false, downloadImplementation: a = bn }) {
  const s = await Cn(e.messages, a, t, r);
  return [...e.system != null ? [{ role: "system", content: e.system }] : [], ...e.messages.map((n) => Rn(n, s))];
}
function Rn(e, t) {
  var r, a, s, n, o, l;
  const c = e.role;
  switch (c) {
    ...
    case "user":
      return typeof e.content == "string" ? { role: "user", content: [{ type: "text", text: e.content }], providerMetadata: (a = e.providerOptions) != null ? a : e.experimental_providerMetadata } : { role: "user", content: e.content.map((u) => Pn(u, t)).filter((u) => u.type !== "text" || u.text !== ""), providerMetadata: (s = e.providerOptions) != null ? s : e.experimental_providerMetadata };
    case "assistant":
      return typeof e.content == "string" ? { role: "assistant", content: [{ type: "text", text: e.content }], providerMetadata: (n = e.providerOptions) != null ? n : e.experimental_providerMetadata } : { role: "assistant", content: e.content.filter((u) => u.type !== "text" || u.text !== "").map((u) => {
        ...
        switch (u.type) {
          case "file":
            return { type: "file", data: u.data instanceof URL ? u.data : Or(u.data), filename: u.filename, mimeType: u.mimeType, providerMetadata: m };
          case "reasoning":
...
function Pn(e, t) {
  ...
  if (c instanceof URL) if (c.protocol === "data:") {
    const { mimeType: m, base64Content: v } = In(c.toString());
  ...
  switch (d) {
    case "image":
      return u instanceof Uint8Array && (o = (a = vn({ data: u, signatures: fn })) != null ? a : o), { type: "image", image: u, mimeType: o, providerMetadata: (s = e.providerOptions) != null ? s : e.experimental_providerMetadata };
    case "file": {
      if (o == null) throw new Error("Mime type is missing for file part");
      return { type: "file", data: u instanceof Uint8Array ? Or(u) : u, filename: e.filename, mimeType: o, providerMetadata: (n = e.providerOptions) != null ? n : e.experimental_providerMetadata };
    }
  }
}
  ...
  for (const n of e) {
    ...
    switch (o.protocol) {
      ...
      case "data:": {
        ...
        else if ((a = n.contentType) != null && a.startsWith("text/")) s.push({ type: "text", text: Sn(et$1(c)) });
        else {
...
var Ur = "AI_MessageConversionError", $r = `vercel.ai.error.${Ur}`, En = Symbol.for($r), Fr, dt = class extends E {
...
function An(e, t) {
  ...
  for (let o = 0; o < e.length; o++) {
    ...
    switch (u) {
      ...
      case "user": {
        if (l.parts == null) n.push({ role: "user", content: m ? [{ type: "text", text: d }, ...tr(m)] : d });
        else {
          const v = l.parts.filter((b) => b.type === "text").map((b) => ({ type: "text", text: b.text }));
          n.push({ role: "user", content: m ? [...v, ...tr(m)] : v });
        }
        break;
      }
      case "assistant": {
...
function jn(e) {
  ...
  const t = e.map(Mn);
  return t.some((r) => r === "has-ui-specific-parts") ? "ui-messages" : t.every((r) => r === "has-core-specific-parts" || r === "message") ? "messages" : "other";
}
function Mn(e) {
...
var bt = z.lazy(() => z.union([z.null(), z.string(), z.number(), z.boolean(), z.record(z.string(), bt), z.array(bt)])), A = z.record(z.string(), z.record(z.string(), bt)), Nn = z.array(z.union([z.object({ type: z.literal("text"), text: z.string() }), z.object({ type: z.literal("image"), data: z.string(), mimeType: z.string().optional() })])), Jr = z.object({ type: z.literal("text"), text: z.string(), providerOptions: A.optional(), experimental_providerMetadata: A.optional() }), On = z.object({ type: z.literal("image"), image: z.union([Nr, z.instanceof(URL)]), mimeType: z.string().optional(), providerOptions: A.optional(), experimental_providerMetadata: A.optional() }), Br = z.object({ type: z.literal("file"), data: z.union([Nr, z.instanceof(URL)]), filename: z.string().optional(), mimeType: z.string(), providerOptions: A.optional(), experimental_providerMetadata: A.optional() }), kn = z.object({ type: z.literal("reasoning"), text: z.string(), providerOptions: A.optional(), experimental_providerMetadata: A.optional() }), Dn = z.object({ type: z.literal("redacted-reasoning"), data: z.string(), providerOptions: A.optional(), experimental_providerMetadata: A.optional() }), qn = z.object({ type: z.literal("tool-call"), toolCallId: z.string(), toolName: z.string(), args: z.unknown(), providerOptions: A.optional(), experimental_providerMetadata: A.optional() }), Un = z.object({ type: z.literal("tool-result"), toolCallId: z.string(), toolName: z.string(), result: z.unknown(), content: Nn.optional(), isError: z.boolean().optional(), providerOptions: A.optional(), experimental_providerMetadata: A.optional() }), $n = z.object({ role: z.literal("system"), content: z.string(), providerOptions: A.optional(), experimental_providerMetadata: A.optional() }), Fn = z.object({ role: z.literal("user"), content: z.union([z.string(), z.array(z.union([Jr, On, Br]))]), providerOptions: A.optional(), experimental_providerMetadata: A.optional() }), Jn = z.object({ role: z.literal("assistant"), content: z.union([z.string(), z.array(z.union([Jr, Br, kn, Dn, qn]))]), providerOptions: A.optional(), experimental_providerMetadata: A.optional() }), Bn = z.object({ role: z.literal("tool"), content: z.array(Un), providerOptions: A.optional(), experimental_providerMetadata: A.optional() }), Gn = z.union([$n, Fn, Jn, Bn]);
function xt({ prompt: e, tools: t }) {
  ...
  if (e.messages != null) {
    const r = jn(e.messages);
    if (r === "other") throw new ra$1({ prompt: e, message: "messages must be an array of CoreMessage or UIMessage" });
    const a = r === "ui-messages" ? An(e.messages, { tools: t }) : e.messages;
    if (a.length === 0) throw new ra$1({ prompt: e, message: "messages must not be empty" });
    const s = ae({ value: a, schema: z.array(Gn) });
    if (!s.success) throw new ra$1({ prompt: e, message: "messages must be an array of CoreMessage or UIMessage", cause: s.error });
...
var Wn = "JSON schema:", Vn = "You MUST answer with a JSON object that matches the JSON schema above.", zn = "You MUST answer with JSON.";
function St({ prompt: e, schema: t, schemaPrefix: r = t != null ? Wn : void 0, schemaSuffix: a = t != null ? Vn : zn }) {
...
var Xn = { type: "no-schema", jsonSchema: void 0, validatePartialResult({ value: e, textDelta: t }) {
...
} }, Hn = (e) => ({ type: "object", jsonSchema: e.jsonSchema, validatePartialResult({ value: t, textDelta: r }) {
...
}, Yn = (e) => ({ type: "enum", jsonSchema: { $schema: "http://json-schema.org/draft-07/schema#", type: "object", properties: { result: { type: "string", enum: e } }, required: ["result"], additionalProperties: false }, validateFinalResult(t) {
...
function Qn({ output: e, schema: t, enumValues: r }) {
  switch (e) {
    case "object":
      return Hn(Na$1(t));
    case "array":
...
function Zn({ output: e, mode: t, schema: r, schemaName: a, schemaDescription: s, enumValues: n }) {
...
function Lr() {
  let e = [], t = null, r = false, a = rr();
  const s = async () => {
    if (r && e.length === 0) {
      t == null ? void 0 : t.close();
      return;
    }
    if (e.length === 0) return a = rr(), await a.promise, s();
    try {
...
var es = At$1({ prefix: "aiobj", size: 24 });
function eo({ model: e, schema: t, schemaName: r, schemaDescription: a, mode: s, output: n = "object", system: o, prompt: l, messages: c, maxRetries: u, abortSignal: d, headers: m, experimental_telemetry: v, experimental_providerMetadata: b, providerOptions: x = b, onError: C, onFinish: w, _internal: { generateId: f = es, currentDate: y = () => /* @__PURE__ */ new Date(), now: N = Wr } = {}, ...h }) {
  Zn({ output: n, mode: s, schema: t, schemaName: r, schemaDescription: a });
  const P = Qn({ output: n, schema: t });
  return P.type === "no-schema" && s === void 0 && (s = "json"), new ts({ model: e, telemetry: v, headers: m, settings: h, maxRetries: u, abortSignal: d, outputStrategy: P, system: o, prompt: l, messages: c, schemaName: r, schemaDescription: a, providerOptions: x, mode: s, onError: C, onFinish: w, generateId: f, currentDate: y, now: N });
}
var ts = class {
  constructor({ model: e, headers: t, telemetry: r, settings: a, maxRetries: s, abortSignal: n, outputStrategy: o, system: l, prompt: c, messages: u, schemaName: d, schemaDescription: m, providerOptions: v, mode: b, onError: x, onFinish: C, generateId: w, currentDate: f, now: y }) {
    ...
    const { maxRetries: N, retry: h } = xr({ maxRetries: s }), P = Sr({ model: e, telemetry: r, headers: t, settings: { ...a, maxRetries: N } }), k = Tr(r), D = this, O = Lr(), pe = new TransformStream({ transform(F, V) {
      V.enqueue(F), F.type === "error" && (x == null ? void 0 : x({ error: F.error }));
    } });
    this.baseStream = O.stream.pipeThrough(pe), $e$1({ name: "ai.streamObject", attributes: Z$1({ telemetry: r, attributes: { ...Ue$1({ operationId: "ai.streamObject", telemetry: r }), ...P, "ai.prompt": { input: () => JSON.stringify({ system: l, prompt: c, messages: u }) }, "ai.schema": o.jsonSchema != null ? { input: () => JSON.stringify(o.jsonSchema) } : void 0, "ai.schema.name": d, "ai.schema.description": m, "ai.settings.output": o.type, "ai.settings.mode": b } }), tracer: k, endWhenDone: false, fn: async (F) => {
      var V, ae;
      ...
      const { result: { stream: se, warnings: be, rawResponse: J, request: xe }, doStreamSpan: de, startTimestampMs: oe } = await h(() => $e$1({ name: "ai.streamObject.doStream", attributes: Z$1({ telemetry: r, attributes: { ...Ue$1({ operationId: "ai.streamObject.doStream", telemetry: r }), ...P, "ai.prompt.format": { input: () => ee.inputFormat }, "ai.prompt.messages": { input: () => JSON.stringify(ee.prompt) }, "ai.settings.mode": b, "gen_ai.system": e.provider, "gen_ai.request.model": e.modelId, "gen_ai.request.frequency_penalty": a.frequencyPenalty, "gen_ai.request.max_tokens": a.maxTokens, "gen_ai.request.presence_penalty": a.presencePenalty, "gen_ai.request.temperature": a.temperature, "gen_ai.request.top_k": a.topK, "gen_ai.request.top_p": a.topP } }), tracer: k, endWhenDone: false, fn: async (S) => ({ startTimestampMs: y(), doStreamSpan: S, result: await e.doStream(ee) }) }));
      ...
      const Ee = se.pipeThrough(new TransformStream(ne)).pipeThrough(new TransformStream({ async transform(S, T) {
        ...
        if (Je) {
          const p = y() - oe;
          Je = false, de.addEvent("ai.stream.firstChunk", { "ai.stream.msToFirstChunk": p }), de.setAttributes({ "ai.stream.msToFirstChunk": p });
        }
        if (typeof S == "string") {
          z += S, re += S;
...
}, Vr = "AI_NoOutputSpecifiedError", zr = `vercel.ai.error.${Vr}`, rs = Symbol.for(zr), Xr, as = class extends E {
  constructor({ message: e = "No output specified." } = {}) {
    super({ name: Vr, message: e }), this[Xr] = true;
  }
  static isInstance(e) {
    return E.hasMarker(e, zr);
  }
};
Xr = rs;
var Hr = "AI_ToolExecutionError", Kr = `vercel.ai.error.${Hr}`, ns = Symbol.for(Kr), Yr, ss = class extends E {
  constructor({ toolArgs: e, toolName: t, toolCallId: r, cause: a, message: s = `Error executing tool ${t}: ${ve$1(a)}` }) {
    super({ name: Hr, message: s, cause: a }), this[Yr] = true, this.toolArgs = e, this.toolName = t, this.toolCallId = r;
  }
  static isInstance(e) {
    return E.hasMarker(e, Kr);
  }
};
Yr = ns;
function os(e) {
...
function is({ tools: e, toolChoice: t, activeTools: r }) {
  return os(e) ? { tools: (r != null ? Object.entries(e).filter(([s]) => r.includes(s)) : Object.entries(e)).map(([s, n]) => {
    const o = n.type;
    switch (o) {
      case void 0:
      case "function":
...
var Qr = "AI_InvalidToolArgumentsError", Zr = `vercel.ai.error.${Qr}`, cs = Symbol.for(Zr), ea, ta = class extends E {
  constructor({ toolArgs: e, toolName: t, cause: r, message: a = `Invalid arguments for tool ${t}: ${ve$1(r)}` }) {
    super({ name: Qr, message: a, cause: r }), this[ea] = true, this.toolArgs = e, this.toolName = t;
  }
  static isInstance(e) {
    return E.hasMarker(e, Zr);
  }
...
ea = cs;
var ra = "AI_NoSuchToolError", aa = `vercel.ai.error.${ra}`, ps = Symbol.for(aa), na, Tt = class extends E {
  constructor({ toolName: e, availableTools: t = void 0, message: r = `Model tried to call unavailable tool '${e}'. ${t === void 0 ? "No tools are available." : `Available tools: ${t.join(", ")}.`}` }) {
    super({ name: ra, message: r }), this[na] = true, this.toolName = e, this.availableTools = t;
  }
  static isInstance(e) {
    return E.hasMarker(e, aa);
  }
};
na = ps;
var sa = "AI_ToolCallRepairError", oa = `vercel.ai.error.${sa}`, ds = Symbol.for(oa), ia, ms = class extends E {
  constructor({ cause: e, originalError: t, message: r = `Error repairing tool call: ${ve$1(e)}` }) {
    super({ name: sa, message: r, cause: e }), this[ia] = true, this.originalError = t;
  }
  static isInstance(e) {
    return E.hasMarker(e, oa);
  }
};
ia = ds;
async function fs({ toolCall: e, tools: t, repairToolCall: r, system: a, messages: s }) {
  if (t == null) throw new Tt({ toolName: e.toolName });
  try {
    return await ar({ toolCall: e, tools: t });
  } catch (n) {
    if (r == null || !(Tt.isInstance(n) || ta.isInstance(n))) throw n;
    let o = null;
    try {
      o = await r({ toolCall: e, tools: t, parameterSchema: ({ toolName: l }) => Na$1(t[l].parameters).jsonSchema, system: a, messages: s, error: n });
    } catch (l) {
      throw new ms({ cause: l, originalError: n });
    }
    if (o == null) throw n;
    return await ar({ toolCall: o, tools: t });
  }
}
async function ar({ toolCall: e, tools: t }) {
  ...
  if (n.success === false) throw new ta({ toolName: r, toolArgs: e.args, cause: n.error });
...
function nr({ text: e = "", files: t, reasoning: r, tools: a, toolCalls: s, toolResults: n, messageId: o, generateMessageId: l }) {
  const c = [], u = [];
...
var gs = {};
jt(gs, { object: () => bs, text: () => ws });
var la = "AI_InvalidStreamPartError", ua = `vercel.ai.error.${la}`, vs = Symbol.for(ua), ca, ys = class extends E {
  constructor({ chunk: e, message: t }) {
    super({ name: la, message: t }), this[ca] = true, this.chunk = e;
  }
  static isInstance(e) {
    return E.hasMarker(e, ua);
  }
};
ca = vs;
var ws = () => ({ type: "text", responseFormat: () => ({ type: "text" }), injectIntoSystemPrompt({ system: e }) {
  return e;
}, parsePartial({ text: e }) {
  return { partial: e };
}, parseOutput({ text: e }) {
...
async function Ss({ stream: e, onError: t }) {
  const r = e.getReader();
  try {
    for (; ; ) {
...
function Ts({ tools: e, generatorStream: t, toolCallStreaming: r, tracer: a, telemetry: s, system: n, messages: o, abortSignal: l, repairToolCall: c }) {
  let u = null;
  ...
  const w = new TransformStream({ async transform(f, y) {
    ...
    switch (N) {
      ...
      case "file": {
        y.enqueue(new mn({ data: f.data, mimeType: f.mimeType }));
        break;
      }
      case "tool-call-delta": {
      ...
      case "tool-call": {
        try {
          const h = await fs({ toolCall: f, tools: e, repairToolCall: c, system: n, messages: o });
          y.enqueue(h);
          ...
          if (P.execute != null) {
            ...
            v.add(k), $e$1({ name: "ai.toolCall", attributes: Z$1({ telemetry: s, attributes: { ...Ue$1({ operationId: "ai.toolCall", telemetry: s }), "ai.toolCall.name": h.toolName, "ai.toolCall.id": h.toolCallId, "ai.toolCall.args": { output: () => JSON.stringify(h.args) } } }), tracer: a, fn: async (D) => P.execute(h.args, { toolCallId: h.toolCallId, messages: o, abortSignal: l }).then((O) => {
              ...
              u.enqueue({ type: "error", error: new ss({ toolCallId: h.toolCallId, toolName: h.toolName, toolArgs: h.args, cause: O }) }), v.delete(k), C();
            }) });
          }
        } catch (h) {
...
var _s = At$1({ prefix: "aitxt", size: 24 }), Is = At$1({ prefix: "msg", size: 24 });
function to({ model: e, tools: t, toolChoice: r, system: a, prompt: s, messages: n, maxRetries: o, abortSignal: l, headers: c, maxSteps: u = 1, experimental_generateMessageId: d = Is, experimental_output: m, experimental_continueSteps: v = false, experimental_telemetry: b, experimental_providerMetadata: x, providerOptions: C = x, experimental_toolCallStreaming: w = false, toolCallStreaming: f = w, experimental_activeTools: y, experimental_repairToolCall: N, experimental_transform: h, onChunk: P, onError: k, onFinish: D, onStepFinish: O, _internal: { now: pe = Wr, generateId: F = _s, currentDate: V = () => /* @__PURE__ */ new Date() } = {}, ...ae }) {
  return new Cs({ model: e, telemetry: b, headers: c, settings: ae, maxRetries: o, abortSignal: l, system: a, prompt: s, messages: n, tools: t, toolChoice: r, toolCallStreaming: f, transforms: xs(h), activeTools: y, repairToolCall: N, maxSteps: u, output: m, continueSteps: v, providerOptions: C, onChunk: P, onError: k, onFinish: D, onStepFinish: O, now: pe, currentDate: V, generateId: F, generateMessageId: d });
}
function Rs(e) {
...
var Cs = class {
  constructor({ model: e, telemetry: t, headers: r, settings: a, maxRetries: s, abortSignal: n, system: o, prompt: l, messages: c, tools: u, toolChoice: d, toolCallStreaming: m, transforms: v, activeTools: b, repairToolCall: x, maxSteps: C, output: w, continueSteps: f, providerOptions: y, now: N, currentDate: h, generateId: P, generateMessageId: k, onChunk: D, onError: O, onFinish: pe, onStepFinish: F }) {
    ...
    const de = [], oe = { id: P(), timestamp: h(), modelId: e.modelId, messages: [] };
    ...
    const q = new TransformStream({ async transform(B, G) {
      ...
      if (p.type === "redacted-reasoning" && se.push({ type: "redacted", data: p.data }), p.type === "file" && be.push(p), p.type === "source" && (de.push(p.source), xe.push(p.source)), p.type === "tool-call" && U.push(p), p.type === "tool-result" && K.push(p), p.type === "step-finish") {
        const $ = nr({ text: ee, files: be, reasoning: se, tools: u != null ? u : {}, toolCalls: U, toolResults: K, messageId: p.messageId, generateMessageId: k }), L = z.length;
        let X = "done";
        L + 1 < C && (f && p.finishReason === "length" && U.length === 0 ? X = "continue" : U.length > 0 && K.length === U.length && (X = "tool-result"));
        const Ge = { stepType: Se, text: ae, reasoning: hs(se), reasoningDetails: se, files: be, sources: xe, toolCalls: U, toolResults: K, finishReason: p.finishReason, usage: p.usage, warnings: p.warnings, logprobs: p.logprobs, request: p.request, response: { ...p.response, messages: [...oe.messages, ...$] }, providerMetadata: p.experimental_providerMetadata, experimental_providerMetadata: p.experimental_providerMetadata, isContinued: p.isContinued };
    ...
    this.baseStream = ue.pipeThrough(Rs(w)).pipeThrough(q);
    const { maxRetries: Je, retry: Be } = xr({ maxRetries: s }), Ee = Tr(t), S = Sr({ model: e, telemetry: t, headers: r, settings: { ...a, maxRetries: Je } }), T = xt({ prompt: { system: (V = w == null ? void 0 : w.injectIntoSystemPrompt({ system: o, model: e })) != null ? V : o, prompt: l, messages: c }, tools: u }), _ = this;
    $e$1({ name: "ai.streamText", attributes: Z$1({ telemetry: t, attributes: { ...Ue$1({ operationId: "ai.streamText", telemetry: t }), ...S, "ai.prompt": { input: () => JSON.stringify({ system: o, prompt: l, messages: c }) }, "ai.settings.maxSteps": C } }), tracer: Ee, endWhenDone: false, fn: async (B) => {
      re = B;
      async function G({ currentStep: p, responseMessages: $, usage: L, stepType: X, previousStepText: Ge, hasLeadingWhitespace: ma, messageId: Le }) {
        var Dt;
        const rt = $.length === 0 ? T.type : "messages", qt = [...T.messages, ...$], Ut = await yt({ prompt: { type: rt, system: T.system, messages: qt }, modelSupportsImageUrls: e.supportsImageUrls, modelSupportsUrl: (Dt = e.supportsUrl) == null ? void 0 : Dt.bind(e) }), We = { type: "regular", ...is({ tools: u, toolChoice: d, activeTools: b }) }, { result: { stream: fa, warnings: at, rawResponse: Ve, request: $t }, doStreamSpan: Te, startTimestampMs: Ft } = await Be(() => $e$1({ name: "ai.streamText.doStream", attributes: Z$1({ telemetry: t, attributes: { ...Ue$1({ operationId: "ai.streamText.doStream", telemetry: t }), ...S, "ai.prompt.format": { input: () => rt }, "ai.prompt.messages": { input: () => JSON.stringify(Ut) }, "ai.prompt.tools": { input: () => {
          var g;
          return (g = We.tools) == null ? void 0 : g.map((j) => JSON.stringify(j));
        } }, "ai.prompt.toolChoice": { input: () => We.toolChoice != null ? JSON.stringify(We.toolChoice) : void 0 }, "gen_ai.system": e.provider, "gen_ai.request.model": e.modelId, "gen_ai.request.frequency_penalty": a.frequencyPenalty, "gen_ai.request.max_tokens": a.maxTokens, "gen_ai.request.presence_penalty": a.presencePenalty, "gen_ai.request.stop_sequences": a.stopSequences, "gen_ai.request.temperature": a.temperature, "gen_ai.request.top_k": a.topK, "gen_ai.request.top_p": a.topP } }), tracer: Ee, endWhenDone: false, fn: async (g) => ({ startTimestampMs: N(), doStreamSpan: g, result: await e.doStream({ mode: We, ...wt(a), inputFormat: rt, responseFormat: w == null ? void 0 : w.responseFormat({ model: e }), prompt: Ut, providerMetadata: y, abortSignal: n, headers: r }) }) })), ha = Ts({ tools: u, generatorStream: fa, toolCallStreaming: m, tracer: Ee, telemetry: t, system: o, messages: qt, repairToolCall: x, abortSignal: n }), Jt = $t != null ? $t : {}, me = [], nt = [], st = [], Bt = [];
        let fe, he = "unknown", ce = { promptTokens: 0, completionTokens: 0, totalTokens: 0 }, Ae, Gt = true, je = "", Lt = X === "continue" ? Ge : "", ot, H = { id: P(), timestamp: h(), modelId: e.modelId }, _e = "", Wt = false, Vt = true, zt = false;
        async function it({ controller: g, chunk: j }) {
          g.enqueue(j), je += j.textDelta, Lt += j.textDelta, Wt = true, zt = j.textDelta.trimEnd() !== j.textDelta;
        }
        _.addStream(ha.pipeThrough(new TransformStream({ async transform(g, j) {
          var Y, Me, ge;
          if (Gt) {
            const Q = N() - Ft;
            Gt = false, Te.addEvent("ai.stream.firstChunk", { "ai.response.msToFirstChunk": Q }), Te.setAttributes({ "ai.response.msToFirstChunk": Q }), j.enqueue({ type: "step-start", messageId: Le, request: Jt, warnings: at != null ? at : [] });
          }
          ...
          switch (Xt) {
            case "text-delta": {
              if (f) {
                const Q = Vt && ma ? g.textDelta.trimStart() : g.textDelta;
                if (Q.length === 0) break;
                Vt = false, _e += Q;
                const ze = us(_e);
                ze != null && (_e = ze.suffix, await it({ controller: j, chunk: { type: "text-delta", textDelta: ze.prefix + ze.whitespace } }));
              } else await it({ controller: j, chunk: g });
              break;
            }
            case "reasoning": {
              j.enqueue(g), fe == null ? (fe = { type: "text", text: g.textDelta }, st.push(fe)) : fe.text += g.textDelta;
              break;
            }
            case "reasoning-signature": {
              if (j.enqueue(g), fe == null) throw new ys({ chunk: g, message: "reasoning-signature without reasoning" });
              fe.signature = g.signature, fe = void 0;
              break;
            }
            case "redacted-reasoning": {
              j.enqueue(g), st.push({ type: "redacted", data: g.data });
              break;
            }
            case "tool-call": {
              j.enqueue(g), me.push(g);
              break;
            }
            case "tool-result": {
              j.enqueue(g), nt.push(g);
              break;
            }
            case "response-metadata": {
              H = { id: (Y = g.id) != null ? Y : H.id, timestamp: (Me = g.timestamp) != null ? Me : H.timestamp, modelId: (ge = g.modelId) != null ? ge : H.modelId };
              break;
            }
            case "finish": {
              ce = g.usage, he = g.finishReason, Ae = g.experimental_providerMetadata, ot = g.logprobs;
              const Q = N() - Ft;
          ...
          const j = me.length > 0 ? JSON.stringify(me) : void 0;
          let Y = "done";
          p + 1 < C && (f && he === "length" && me.length === 0 ? Y = "continue" : me.length > 0 && nt.length === me.length && (Y = "tool-result")), f && _e.length > 0 && (Y !== "continue" || X === "continue" && !Wt) && (await it({ controller: g, chunk: { type: "text-delta", textDelta: _e } }), _e = "");
          try {
            Te.setAttributes(Z$1({ telemetry: t, attributes: { "ai.response.finishReason": he, "ai.response.text": { output: () => je }, "ai.response.toolCalls": { output: () => j }, "ai.response.id": H.id, "ai.response.model": H.modelId, "ai.response.timestamp": H.timestamp.toISOString(), "ai.usage.promptTokens": ce.promptTokens, "ai.usage.completionTokens": ce.completionTokens, "gen_ai.response.finish_reasons": [he], "gen_ai.response.id": H.id, "gen_ai.response.model": H.modelId, "gen_ai.usage.input_tokens": ce.promptTokens, "gen_ai.usage.output_tokens": ce.completionTokens } }));
          } catch {
          } finally {
            Te.end();
          }
          g.enqueue({ type: "step-finish", finishReason: he, usage: ce, providerMetadata: Ae, experimental_providerMetadata: Ae, logprobs: ot, request: Jt, response: { ...H, headers: Ve == null ? void 0 : Ve.headers }, warnings: at, isContinued: Y === "continue", messageId: Le });
          const Me = Ln(L, ce);
          if (Y === "done") g.enqueue({ type: "finish", finishReason: he, usage: Me, providerMetadata: Ae, experimental_providerMetadata: Ae, logprobs: ot, response: { ...H, headers: Ve == null ? void 0 : Ve.headers } }), _.closeStream();
          else {
            if (X === "continue") {
              const ge = $[$.length - 1];
              typeof ge.content == "string" ? ge.content += je : ge.content.push({ text: je, type: "text" });
            } else $.push(...nr({ text: je, files: Bt, reasoning: st, tools: u != null ? u : {}, toolCalls: me, toolResults: nt, messageId: Le, generateMessageId: k }));
            await G({ currentStep: p + 1, responseMessages: $, usage: Me, stepType: Y, previousStepText: Lt, hasLeadingWhitespace: zt, messageId: Y === "continue" ? Le : k() });
          }
        } })));
      }
  ...
  async consumeStream(e) {
    var t;
    try {
      await Ss({ stream: this.fullStream, onError: e == null ? void 0 : e.onError });
    } catch (r) {
      (t = e == null ? void 0 : e.onError) == null || t.call(e, r);
    }
  }
  get experimental_partialOutputStream() {
    if (this.output == null) throw new as();
  ...
  toDataStream(e) {
    ...
    return (e == null ? void 0 : e.data) ? Mt(e == null ? void 0 : e.data.stream, t) : t;
  }
...
}, Ps = z.object({ name: z.string(), version: z.string() }).passthrough(), Nt = z.object({ _meta: z.optional(z.object({}).passthrough()) }).passthrough(), Fe$1 = Nt, Es = z.object({ method: z.string(), params: z.optional(Nt) }), As = z.object({ experimental: z.optional(z.object({}).passthrough()), logging: z.optional(z.object({}).passthrough()), prompts: z.optional(z.object({ listChanged: z.optional(z.boolean()) }).passthrough()), resources: z.optional(z.object({ subscribe: z.optional(z.boolean()), listChanged: z.optional(z.boolean()) }).passthrough()), tools: z.optional(z.object({ listChanged: z.optional(z.boolean()) }).passthrough()) }).passthrough();
Fe$1.extend({ protocolVersion: z.string(), capabilities: As, serverInfo: Ps, instructions: z.optional(z.string()) });
var js = Fe$1.extend({ nextCursor: z.optional(z.string()) }), Ms = z.object({ name: z.string(), description: z.optional(z.string()), inputSchema: z.object({ type: z.literal("object"), properties: z.optional(z.object({}).passthrough()) }).passthrough() }).passthrough();
js.extend({ tools: z.array(Ms) });
var Ns = z.object({ type: z.literal("text"), text: z.string() }).passthrough(), Os = z.object({ type: z.literal("image"), data: z.string().base64(), mimeType: z.string() }).passthrough(), pa = z.object({ uri: z.string(), mimeType: z.optional(z.string()) }).passthrough(), ks = pa.extend({ text: z.string() }), Ds = pa.extend({ blob: z.string().base64() }), qs = z.object({ type: z.literal("resource"), resource: z.union([ks, Ds]) }).passthrough();
Fe$1.extend({ content: z.array(z.union([Ns, Os, qs])), isError: z.boolean().default(false).optional() }).or(Fe$1.extend({ toolResult: z.unknown() }));
var tt$1 = "2.0", Us = z.object({ jsonrpc: z.literal(tt$1), id: z.union([z.string(), z.number().int()]) }).merge(Es).strict(), $s = z.object({ jsonrpc: z.literal(tt$1), id: z.union([z.string(), z.number().int()]), result: Fe$1 }).strict(), Fs = z.object({ jsonrpc: z.literal(tt$1), id: z.union([z.string(), z.number().int()]), error: z.object({ code: z.number().int(), message: z.string(), data: z.optional(z.unknown()) }) }).strict(), Js = z.object({ jsonrpc: z.literal(tt$1) }).merge(z.object({ method: z.string(), params: z.optional(Nt) })).strict();
z.union([Us, Js, $s, Fs]);
var Bs = {};
jt(Bs, { mergeIntoDataStream: () => Ws, toDataStream: () => Gs, toDataStreamResponse: () => Ls });
function da(e = {}) {
...
function Ot(e, t) {
  return e.pipeThrough(new TransformStream({ transform: async (r, a) => {
    ...
    if ("event" in r) {
      r.event === "on_chat_model_stream" && sr((s = r.data) == null ? void 0 : s.chunk, a);
      return;
    }
    sr(r, a);
  } })).pipeThrough(da(t)).pipeThrough(new TextDecoderStream()).pipeThrough(new TransformStream({ transform: async (r, a) => {
    a.enqueue(ka$1("text", r));
  } }));
}
function Gs(e, t) {
  return Ot(e, t).pipeThrough(new TextEncoderStream());
}
function Ls(e, t) {
  var r;
  const a = Ot(e, t == null ? void 0 : t.callbacks).pipeThrough(new TextEncoderStream()), s = t == null ? void 0 : t.data, n = t == null ? void 0 : t.init, o = s ? Mt(s.stream, a) : a;
...
function Ws(e, t) {
  t.dataStream.merge(Ot(e, t.callbacks));
}
function sr(e, t) {
...
var Vs = {};
jt(Vs, { mergeIntoDataStream: () => Hs, toDataStream: () => zs, toDataStreamResponse: () => Xs });
function kt(e, t) {
  const r = Ks();
  return la$1(e[Symbol.asyncIterator]()).pipeThrough(new TransformStream({ async transform(a, s) {
    s.enqueue(r(a.delta));
  } })).pipeThrough(da(t)).pipeThrough(new TextDecoderStream()).pipeThrough(new TransformStream({ transform: async (a, s) => {
...
function Xs(e, t = {}) {
  var r;
  const { init: a, data: s, callbacks: n } = t, o = kt(e, n).pipeThrough(new TextEncoderStream()), l = s ? Mt(s.stream, o) : o;
...
var xe = class {
  ...
  getArgs({ audio: t, mediaType: s, providerOptions: a }) {
    var d, u, p, n, o;
    const i = [], r = ma({ provider: "openai", providerOptions: a, schema: Ae }), h = new FormData(), c = t instanceof Uint8Array ? new Blob([t]) : new Blob([Ia$1(t)]);
...
var it = { webSearchPreview: ot }, at = z.object({ instructions: z.string().nullish(), speed: z.number().min(0.25).max(4).default(1).nullish() }), rt = class {
  ...
  getArgs({ text: t, voice: s = "alloy", outputFormat: a = "mp3", speed: d, instructions: u, providerOptions: p }) {
    const n = [], o = ma({ provider: "openai", providerOptions: p, schema: at }), i = { model: this.modelId, input: t, voice: s, response_format: "mp3", speed: d, instructions: u };
...
export { Zs as Z, eo as e, pt as p, to as t };
//# sourceMappingURL=index-Cq4QIKmz.mjs.map
